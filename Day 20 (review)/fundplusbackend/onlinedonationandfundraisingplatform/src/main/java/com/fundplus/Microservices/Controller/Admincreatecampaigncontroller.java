...
public class Admincreatecampaigncontroller {
  ...
  // public ResponseEntity<?> Adminsavecampaigns(@RequestBody Admincreatecampaign campaigns) {
  //   ResponseEntity<Admincreatecampaign> response = admincreatecampaignserviceimpl.saveCreateCampaign(campaigns);
  ...
  // return new ResponseEntity<>("User with id "+id+" is deleted successfully"
  // ,HttpStatus.OK);
  // }
