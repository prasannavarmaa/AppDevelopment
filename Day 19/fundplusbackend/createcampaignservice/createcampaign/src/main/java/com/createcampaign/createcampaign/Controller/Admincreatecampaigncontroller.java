...
public class Admincreatecampaigncontroller {
  ...
  // public ResponseEntity<?> saveAdmincampaigns(@RequestBody Admincreatecampaign campaigns)
  // {
  //   boolean response=admincreatecampaignserviceimpl.saveAdmincampaigns(campaigns);
  //   if(response)
  //   {
